...
class GalleryController extends Controller
{
    ...
    public function adminEditAction(Request $request, $id)
    {
        ...
        if (!$form->isSubmitted()) {
            return ['mainPhoto' => $mainPhoto, 'galleries' => $this->getGalleries(), 'gallery' => $gallery, 'form' => $form->createView()];
        }
    ...
    public function adminListPhotos(Request $request, $id)
    {
        ...
        if (!$form->isSubmitted()) {
            return ['galleries' => $this->getGalleries(), 'gallery' => $gallery, 'form' => $form->createView()];
        }
